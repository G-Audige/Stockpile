  ...
  if (keyCode === 87 || keyCode === 38) {
    switch (up) {
      ...
      case "5":
        ...
        activeMin.stamina--;
        activeMin.counter--;
        if (up == 5) activeMin.foodPipsHeld++;
        break;
    }
  ...
  // Down
    ...
    switch (down) {
      ...
      case "5":
        ...
        activeMin.stamina--;
        activeMin.counter--;
        if (down == 5) activeMin.foodPipsHeld++;
        break;
    }
    drawBoard(activeMin.position.color);
  }
  // Left
    ...
    switch (left) {
      ...
      case "5":
        ...
        activeMin.stamina--;
        activeMin.counter--;
        if (left == 5) activeMin.foodPipsHeld++;
        break;
    }
    drawBoard(activeMin.position.color);
  }
...
function showEndScreen() {
  ...
  if (nest1 > nest2) {
    ...
    winner.textContent =
      "Finding their hoards to be equal, Blue and Purple both vow to come out on top next year.";
  }
}
